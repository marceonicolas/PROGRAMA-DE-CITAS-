            ...
            for i, row in df.iterrows():
                ...
                with st.expander(f"📅 {fecha_formato} | 🕒 {row['hora']} - {row['nombre']} {row['apellido']} ({row['estado']})"):
                    ...
                    with col2:
                        ...
                        msg_sem = f"Hola {nombre_full}, ¿cómo estás? Paso a saludarte y a recordarte que seguimos con el espacio disponible para tu consulta Cuidar tu salud dental/estética a tiempo siempre es la mejor inversión. ¡Quedo atento por si lograste revisar tus horarios para esta semana! Saludos."
