...
if not st.session_state['logged_in']:
   ...
   # 2. REGISTRAR CLIENTE
        ...
        # El botón ahora ejecuta la lógica de guardado
        if st.button("Guardar Registro", type="primary"):
            if n and a:
                ...
                # Éxito y limpieza mediante rerun manual o asignación previa
                st.success(f"¡Cliente {n} {a} guardado!")
                
                # Para evitar el error de API Exception, usamos este truco:
