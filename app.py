        ...
        with st.form("reg"):
            ...
            if st.form_submit_button("Guardar"):
                if n and a: # Validación básica
                    ...
                    # 1. Obtenemos el índice de "Agenda" en la lista de menú
                    # 2. Guardamos la elección en una clave de session_state que controle el selectbox
                    st.session_state['menu_index'] = 0 # 0 suele ser la posición de "Agenda"
                    
                    # Usamos st.rerun() para que al recargar, el selectbox lea la nueva posición
                    st.rerun()
                else:
