...
if not st.session_state['logged_in']:
  ...
  # 2. REGISTRAR CLIENTE
        ...
        # Al poner clear_on_submit=True, Streamlit limpia los campos al presionar el botón
        with st.form("form_registro", clear_on_submit=True):
            ...
            if submit_button:
                if n and a:
                    ...
                    # Al terminar, mostramos el éxito. 
                    # Los campos ya estarán vacíos por el clear_on_submit=True
            ...
            if submit_pass:
                if nueva_pass:
                    if nueva_pass == confirmar_pass:
                        ...
                        try:
                            # Actualizamos en la base de datos para el usuario logueado
